...
## Getting Started
You can include the action in your workflow as `actions/amplify-cli-action@0.4.2`. Example (configuring amplify, building and deploying):
...
jobs:
  test:
    ...
    - name: configure amplify
      uses: AresFitness/amplify-cli-action@0.4.2
      with:
